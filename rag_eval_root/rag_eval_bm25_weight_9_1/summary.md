...
- Generated at: 2026-04-29T10:58:44
- Index: `D:\AgentProject\RAG\FictionRag\data\index\chunks.jsonl`
- Output dir: `rag_eval_root\rag_eval_bm25_weight_9_1`
- Dataset reused: `True`
...
| --- | ---: | --- |
| Recall@1 | 10.20% | gold chunk 出现在第 1 个召回结果中的比例。 |
| Recall@3 | 79.59% | gold chunk 出现在前 3 个召回结果中的比例。 |
| Recall@5 | 87.76% | gold chunk 出现在前 5 个召回结果中的比例。 |
| MRR | 0.4116 | gold chunk 排名越靠前越接近 1。未命中按 0 计算。 |
| Top1 Hit Rate | 10.20% | 与 Recall@1 相同，是最严格的直接命中能力。 |
| Average Gold Rank | 2.47 | 只在命中的样本中计算 gold chunk 的平均排名。 |
| Missed Count | 6 | gold chunk 未出现在 Top 5 的样本数量。 |
...
- Retrieved top chunks: `book-000035, book-000147, book-000148, book-000149, book-000150`
- Reference answer: 因为她丧失了自信，因为对手突然变强。

### 5. 走私组织是如何成功掳走圣兽的？

- Gold chunk: `book-000127`
- Retrieved top chunks: `book-000128, book-000129, book-000130, book-000131, book-000132`
- Reference answer: 他们先雇用诱拐集团绑架小孩和女性，并派出武装集团攻击其他村庄，使德路迪亚族战士被调走，趁德路迪亚村防守不足时袭击并掳走圣兽和族长的孙女。
